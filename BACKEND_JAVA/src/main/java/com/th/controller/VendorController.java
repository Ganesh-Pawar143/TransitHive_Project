...
public class VendorController {
	...
	public ResponseEntity<ApiResponse> changeVendorStatus(@PathVariable Long id, @RequestParam Status status) {
		System.out.println(status);
		VendorDTO updatedVendor = vendorService.changeVendorStatus(id, status);
